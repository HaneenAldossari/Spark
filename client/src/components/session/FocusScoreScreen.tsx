...
const TEXT = {
  ...
  ar: {
    label: 'درجة التركيز',
    breathBonus: 'منحت نفسك لحظةً للتنفّس. هذا مهمّ.',
    startOver: 'العودة للرئيسيّة ←',
    ready: {
      title: 'دماغك مهيَّأ.',
      sub: (task: string) => `ابدأ ${task}.`,
    },
    almost: {
      title: 'أنت في مرحلة الإحماء.',
      sub: 'جولة إضافيّة ستشحذك أكثر.',
    },
    notReady: {
      title: 'دماغك يحتاج إحماءً أكثر.',
      sub: (task: string) => `حاول مجدّدًا قبل ${task}.`,
    },
  },
} as const;
