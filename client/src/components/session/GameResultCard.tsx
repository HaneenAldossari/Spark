...
const MESSAGES: Record<'en' | 'ar', Record<string, Record<Tier, string>>> = {
  ...
  ar: {
    schulte: {
      high: 'عينٌ حادّة. وجدتَ الأرقام الـ{numbersFound} كلّها في {timeTakenSec} ثانية.',
      mid:  'مسحٌ جيّد. وجدتَ {numbersFound} في {timeTakenSec} ثانية.',
      low:  'انتهى الإحماء. ستكون اللعبة التالية أكثر حدّة.',
    },
    nback: {
      high: 'ذاكرةٌ قويّة. {correct} إجابة صحيحة، وسلسلة بلغت {bestStreak}.',
      mid:  '{correct} إجابة صحيحة. الذاكرة العاملة في طور الإحماء.',
      low:  'لعبةٌ عسيرة. كان دماغك منتبهًا في كلّ جولة.',
    },
    dotconnect: {
      high: 'حللتَ {puzzlesSolved} ألغاز. تفكيرٌ مكانيّ متقن.',
      mid:  'حللتَ {puzzlesSolved} من {totalPuzzles}. تخطيطٌ جيّد.',
      low:  'انتهى الإحماء المكانيّ. ستستفيد منه الألعاب التالية.',
    },
    speedmath: {
      high: '{correctAnswers}/{totalRounds} إجابة صحيحة. أسرع إجابة: {fastestSec} ثانية.',
      mid:  '{correctAnswers} إجابة صحيحة. بمعدّل {avgResponseSec} ثانية لكلّ سؤال.',
      low:  'الأرقام في طور التسخين. بدأ الدماغ بالانخراط.',
    },
    stroop: {
      high: '{stroopCorrect}/{stroopTotal} إجابة صحيحة. بمعدّل {stroopAvgSec} ثانية — سرعةٌ عالية.',
      mid:  '{stroopCorrect} إجابة صحيحة. التحكّم المعرفيّ نشِط.',
      low:  'تضارب الألوان حقيقيّ. لكنّك صمدتَ.',
    },
    navon: {
      high: '{correctAnswers}/{totalRounds} إجابة صحيحة. تركيزٌ محكَم على التفاصيل.',
      mid:  '{correctAnswers} إجابة صحيحة. لم يخدعك الشكل الكبير.',
      low:  'انتهى الإحماء البصريّ. ستستفيد منه اللعبة التالية.',
    },
    mentalrotation: {
      high: '{correctAnswers}/{totalRounds} إجابة صحيحة. حسٌّ مكانيّ قويّ.',
      mid:  '{correctAnswers} إجابة صحيحة. القشرة الجداريّة عاملة.',
      low:  'الدوران عسير. تمدَّد دماغك.',
    },
  },
};
