...
> = {
  schulte: {
    ...
    ar: {
      name: 'جدول شولتي',
      rule: 'اعثر على الأرقام بالترتيب.',
      explainer: 'ستظهر أمامك شبكة من الأرقام المختلطة. اضغط عليها بالترتيب من 1 فصاعدًا، بأقصى سرعة ممكنة. ثبِّت عينيك في المنتصف واستخدم الرؤية المحيطيّة.',
    },
  },
  nback: {
    en: {
    ...
    ar: {
      name: 'الذاكرة النشطة',
      rule: 'هل الموضع نفسه قبل جولتين؟',
      explainer: 'في كلّ جولة يضيء مربّع في شبكة 3×3. إذا كان الموضع الحاليّ مطابقًا للموضع قبل جولتين فاضغط "تطابق"، وإلّا فاضغط "مختلف".',
    },
  },
  dotconnect: {
    en: {
    ...
    ar: {
      ...
      explainer: 'اسحب لتصِل كلّ زوج من النقاط بخطٍّ من اللون نفسه. لا يجوز تقاطع الخطوط أو خروجها عن الشبكة. اِملأ الشبكة كلّها قبل انتهاء الوقت.',
    },
  },
  speedmath: {
    en: {
    ...
    ar: {
      name: 'الحساب السريع',
      rule: 'مسائل بسيطة. أجِب بسرعة.',
      explainer: 'ستظهر أمامك مسائل حسابيّة بسيطة، واحدة تلو الأخرى. اضغط الإجابة الصحيحة بأقصى سرعة ممكنة. كلّما كنتَ أسرع، حصلتَ على نقاط أكثر.',
    },
  },
  stroop: {
    en: {
    ...
    ar: {
      ...
      explainer: 'ستظهر كلمة دالّة على لون مكتوبة بحبرٍ مغاير (مثلًا كلمة "أحمر" مكتوبة بالأزرق). تجاهل الكلمة، واضغط لون الحبر الذي كُتبت به.',
    },
  },
  navon: {
    en: {
    ...
    ar: {
      name: 'حروف نافون',
      rule: 'اختر الحرف الصغير.',
      explainer: 'سيظهر أمامك حرفٌ كبير مكوَّن من حروف صغيرة عديدة. تجاهل الشكل الكبير، واضغط الحرف الصغير المتكرّر.',
    },
  },
  mentalrotation: {
    en: {
    ...
    ar: {
      ...
      explainer: 'سيظهر أمامك شكلان متجاوران، كلٌّ منهما مُدار بزاوية مختلفة. قرِّر: هل هما الشكل نفسه، أم أنّ أحدهما صورة مرآة للآخر؟',
    },
  },
  ruleswitch: {
    en: {
